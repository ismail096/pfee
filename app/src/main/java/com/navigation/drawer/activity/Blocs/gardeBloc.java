...
public class gardeBloc extends LinearLayout {
    public Pharmacie pharmacie = null ;
    public gardeBloc(Context context , Pharmacie pharmacie) {
        super(context);
        ...
        img.setImageDrawable(getResources().getDrawable(R.drawable.garde));
        ...
        tv.setText(pharmacie.getPharmacie()+" - "+pharmacie.getSecteur());
