...
public class DirectionFinder {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyBDTWgO6caHiTKdxGJFcDpE80aAGOct2ng";
    ...
    private String createUrl() throws UnsupportedEncodingException {
        ...
        Log.i("wiliba",DIRECTION_URL_API + "origin=" + urlOrigin + "&destination=" + urlDestination);
